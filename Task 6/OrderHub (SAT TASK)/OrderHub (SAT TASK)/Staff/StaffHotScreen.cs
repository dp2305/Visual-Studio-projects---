...
namespace OrderHub__SAT_Task_.Staff
{
    public partial class StaffHotScreen : Form
    {
        ...
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "HotChoco", lsvOutput);
        }

        private void btnFlatWhite_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "FlatWhite", lsvOutput);
        }

        private void btnAmericano_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "Americano", lsvOutput);
        }

        private void btnCortado_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "Cortado", lsvOutput);
        }

        private void btnMocha_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "Mocha", lsvOutput);
        }

        private void btnCappauccino_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "cappauccino", lsvOutput);
        }

        private void btnLatte_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "Latte", lsvOutput);
        }

        private void btnAffogato_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("HotFoodltem.xml", "Affogato", lsvOutput);
        }
