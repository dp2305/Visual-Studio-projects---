...
{
    public partial class StaffChristmasScreen : Form
    {
        public StaffChristmasScreen()
        {
            InitializeComponent();
        }
        ...
        private void btnCandiedYams_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("ChristmasFoodItem.xml", "CandiedYams", lsvOutput);
        }

        private void btnPigsinBlankets_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("ChristmasFoodItem.xml", "PiginBlanket", lsvOutput);
        }

        private void btnGingerBread_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("ChristmasFoodItem.xml", "GingerBread", lsvOutput);
        }

        private void btnEggnog_Click(object sender, EventArgs e)
        {
            XmlHelper.DisplayItemDetails("ChristmasFoodItem.xml", "Eggnog", lsvOutput);
        }
